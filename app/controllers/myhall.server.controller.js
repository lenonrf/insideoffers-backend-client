...
exports.filterByAffiliationCode = function(req, res) {
    ...
    Affiliation.findOne({code: req.query.affcode}).exec(function(err, affiliation) {
        ...
        MyHall.findOne({affiliation: ObjectId(affiliation._id)},{})
            ...
            .exec(function(err, myhall) {
                ...
                request({ 
                    uri: 'http://localhost:3009/users/email/'+req.query.user,
                    method: 'GET',
                    ...
                    if(!_.isEmpty(user)){
                        user.deviceAccess = {};  
                        user.deviceAccess = (req.query.device) ? req.query.device : {};    
                    }                                         
